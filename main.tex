...
\begin{figure}[ht]
	...
	\subcaptionbox{\textit{Sim10k} with augmentations}{
		\includegraphics[width=.47\linewidth]{imgs/sim10kaug.png}
	}
	\subcaptionbox{\textit{CityScapes} without augmentations}{
		\includegraphics[width=.47\linewidth]{imgs/cityscapesorig.png}
	}
...
% TODO: red bounding boxes

% TODO: autoaugment: problems in geometric operations on small objects (no more present in boxes) and on background only (image modified, objects covered and no more in boxes)
...
\begin{figure}[ht!]
	...
	\subcaptionbox{Source image}{
		\includegraphics[width=.4\linewidth]{imgs/src.png}
	}
	\subcaptionbox{Target image}{
		\includegraphics[width=.4\linewidth]{imgs/tgt.png}
	}\\
	\subcaptionbox{Feature Distribution Matching}{
		\includegraphics[width=.4\linewidth]{imgs/fdm.png}
	}
	\subcaptionbox{Histogram Matching}{
		\includegraphics[width=.4\linewidth]{imgs/hm.png}
	}
...
\begin{table}[ht!]
	...
	\begin{tabularx}{\linewidth}{|X|c|}
		...
		\hline
		Baseline (w/ FPN, HFlip + rotation + translation + shearing + color jitter + solarize + equalize)       &   ??.?   \\
		\hline
