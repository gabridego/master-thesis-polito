...
\titolo{Exploring \quotes{simple} approaches for Domain Adaptive Object Detection}% 
...
\begin{citazioni}
	\textit{\quotes{testo testo testo\\~testo testo testo}}
...
\begin{figure}[ht]
	\centering
	\subcaptionbox{Adversarial alignment on features extracted by the \gls{fpn} from \gls{resnet} layers\label{fig:adapt_fpn}}{
